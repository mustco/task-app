    ...
    <DashboardLayout user={userProfile}>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600">Kelola catatan dan tenggat waktu Anda</p>
        </div>

        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white p-6 rounded-lg shadow border bg-white/70 shadow-sm backdrop-blur" >
